...
const testblog = {
  ...
  "authorId": "69c8478b33df5c4a4a7ced42",
  "body": [
    {
      "type": "header",
      "data": {
        "text": "GigaDevice shares surge 54% in Hong Kong trading debut",
        "level": 2
      }
    },
    {
    ...
    },
    {
      "type": "header",
      "data": {
        "text": "Strong financials behind the IPO demand",
        "level": 3
      }
    },
    {
    ...
    },
    {
      "type": "paragraph",
      "data": {
        "text": "The company is best known for its GD32 series of microcontrollers, which compete directly with STMicroelectronics and NXP products in industrial and consumer applications. It has quietly built a substantial customer base in China, where domestic procurement preferences have shifted since 2019. Its NOR flash products are used in everything from smart home devices to automotive dashboards."
      }
    },
    {
      "type": "paragraph",
      "data": {
        "text": "GigaDevice is not trying to compete with TSMC or Samsung in advanced logic chips. It operates in a different part of the market, one with steadier demand and fewer geopolitical complications around manufacturing equipment. That positioning has helped it grow consistently even as higher-profile chip companies have faced supply chain disruptions and demand slowdowns."
      }
    },
    {
      "type": "header",
      "data": {
        "text": "Investor confidence in China's chip sector",
        "level": 3
      }
    },
    {
      "type": "paragraph",
      "data": {
        "text": "The reception GigaDevice received is a useful data point for the broader question of how much confidence investors currently have in Chinese semiconductor companies. After years of skepticism about whether domestic Chinese chipmakers could build real businesses rather than state-subsidized operations, a company turning $84 million in profit in a single half-year period and growing at 14% tends to change that conversation."
      }
    },
    {
      "type": "paragraph",
      "data": {
        "text": "The next test will be whether GigaDevice can sustain that growth rate through the second half of 2025 and into 2026. Its IPO prospectus flagged expansion plans including increased R&D spending on next-generation microcontrollers. If those products reach commercial availability on schedule, the current valuation could look reasonable in hindsight."
      }
    }
  ],
  "category": "technology",
  ...
  "thumbnail": {
    "title": "GigaDevice shares surge 54% in Hong Kong trading debut",
    "description": "Chinese chipmaker GigaDevice surged 54% on its Hong Kong debut after raising $600 million, backed by 14% profit growth in early 2025.",
    "image": "https://images.unsplash.com/photo-1518770660439-4636190af475"
  },
  "title": "GigaDevice shares surge 54% in Hong Kong trading debut",
  "url": "gigadevice-shares-surge-54-percent-hong-kong-trading-debut",
  "videoUrl": "",
  "views": 0
}
...
export default function Profile() {
  ...
  return (
    <AppLayout>
      ...
      <button onClick={() => postToApi()}>postToApi</button>
