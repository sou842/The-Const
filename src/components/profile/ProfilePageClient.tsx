...
export function ProfilePageClient() {
  ...
  const { data, isLoading: profileLoading, mutate } = useSWR(
  ...
  const {
    ...
    user ? "/api/users/profile/blogs" : null,
    getter,
    preventRerendering,
  );
          ...
          <div className="flex flex-col sm:flex-row sm:items-start justify-between mt-3 gap-4">
            <div>
              ...
              <div className="flex items-center gap-4 mt-3 text-sm">
                <span>
                  <strong>{connectionsData?.total ?? 0}</strong>{" "}
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(event) =>
                  setFormData({ ...formData, shortBio: event.target.value })
                }
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(event) =>
                  setFormData({ ...formData, longBio: event.target.value })
                }
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(event) =>
                  setFormData({ ...formData, profilePhoto: event.target.value })
                }
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(event) =>
                  setFormData({ ...formData, bannerPhoto: event.target.value })
                }
