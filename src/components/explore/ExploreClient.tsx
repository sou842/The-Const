...
interface ExploreClientProps {
  initialBlogs: Blog[];
  initialTrending: TrendingTag[];
}

export function ExploreClient({ initialBlogs, initialTrending }: ExploreClientProps) {
  ...
  const { data, isLoading } = useSWR(
    ...
    getter,
    {
      fallbackData: { blogs: initialBlogs, trendingTags: initialTrending },
